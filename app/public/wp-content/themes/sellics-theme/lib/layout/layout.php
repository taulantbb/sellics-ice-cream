...
/*
 *
 * AUTO INCLUDE LAYOUT PARTIALS - BE CAREFUL!
 *
 * */

foreach (scandir(dirname(__FILE__) . '/partials/') as $filename) {
    $path = dirname(__FILE__) . '/partials/' . $filename;
    if (is_file($path)) {
        require_once $path;
    }
}
